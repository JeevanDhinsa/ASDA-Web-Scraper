...
try:
    ...
    departmentlink = WebDriverWait(driver, 10).until(
        EC.presence_of_all_elements_located((By.CSS_SELECTOR, ".aisle__link[href*='aisle/food-cupboard']"))  
    )
...
product_urls1 = split_product_urls[0]
...
df1 = pd.read_csv("frozenfooddata1.csv")
df2 = pd.read_csv("frozenfooddata2.csv")
df3 = pd.read_csv("frozenfooddata3.csv")
df4 = pd.read_csv("frozenfooddata4.csv")
df5 = pd.read_csv("frozenfooddata5.csv")
df6 = pd.read_csv("frozenfooddata6.csv")
df7 = pd.read_csv("frozenfooddata7.csv")
df8 = pd.read_csv("frozenfooddata8.csv")
df9 = pd.read_csv("frozenfooddata9.csv")
df10 = pd.read_csv("frozenfooddata10.csv")
...
# concatenated_df.to_csv("frozenfooddata.csv", index = False, encoding='utf-8-sig')
